...
#define OCT_UP_START_Y 0
#define OCT_UP_WIDTH 0
#define OCT_UP_HEIGHT 0

#define OCT_DOWN_START_X 0
#define OCT_DOWN_START_Y 0
#define OCT_DOWN_WIDTH 0
#define OCT_DOWN_HEIGHT 0

#define OCT_SIDE_START_X 0
#define OCT_SIDE_START_Y 0
#define OCT_SIDE_WIDTH 0
#define OCT_SIDE_HEIGHT 0
